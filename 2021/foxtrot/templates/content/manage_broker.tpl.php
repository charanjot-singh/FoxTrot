                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <input type="text" name="zip_code_general" id="zip_code_general" value="<?php if($action=='edit'){echo isset($zip_code)?$zip_code:'';} ?>" placeholder="99999 or 99999-9999" class="form-control" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="panel" style="border: 1px solid #cccccc !important; padding: 10px !important;">
                              ...
                              <div class="row">
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <label>City </label>
                                       <input type="text" name="business_city" id="business_city" value="<?php if($action=='edit'){ echo isset($business_city)?$business_city:''; } ?>" class="form-control" />
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <select name="business_state" id="business_state" class="form-control">
                                          <option value="">Select State</option>
                                          <?php foreach($get_state as $statekey=>$stateval){?>
                                          <option <?php if($action == 'edit' && $business_state == $stateval['id'] ){ echo 'selected="true"';} ?> value="<?php echo $stateval['id']; ?>"><?php echo $stateval['name']; ?></option>
                                          <?php } ?>
                                       </select>
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <label>Zip code </label>
                                       <input type="text" name="business_zipcode" id="business_zipcode" value="<?php if($action=='edit'){echo isset($business_zipcode)?$business_zipcode:'';} ?>" placeholder="99999 or 99999-9999" class="form-control" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="telephone_general" id="telephone_general" value="<?php if($action=='edit'){echo $telephone;} ?>" placeholder="(999) 999-9999" class="form-control" />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label>Cell </label>
                                    <input type="text" name="cell_general" placeholder="(999) 999-9999" id="cell_general" value="<?php if($action=='edit'){echo $cell;} ?>" class="form-control" />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label>Fax </label>
                                    <input type="text" name="fax_general" placeholder="(999) 999-9999" id="fax_general" value="<?php if($action=='edit'){ echo $fax;} ?>" class="form-control" />
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <select name="reassign_broker_general" id="reassign_broker_general" class="form-control">
                                       ...
                                       <option value="<?php echo $val['id'];?>" <?php if($reassign_broker != '' && $reassign_broker==$val['id']){echo "selected='selected'";} ?>><?php echo $val['last_name'].', '.$val['first_name'];?></option>
                                       <?php } ?>
                                    </select>
                                    <!--<select name="reassign_broker_general" id="reassign_broker_general" class="form-control">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <input type="text" name="routing_general" id="routing_general" value="<?php if($action=='edit'){ echo $routing;} ?>" class="form-control" maxlength="9" placeholder="999999999"  minlength="9" />
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
               ...
               <div class="tab-pane <?php if(isset($_GET['tab'])&&$_GET['tab']=="payouts"){ echo "active"; } ?>" id="tab_b">
                  ...
                  <div class="panel-overlay-wrap">
                     <div class="panel">
                        ...
                        <div class="panel-body">
                           <h4>
                              Payout Schedule <!--<a href="#broker_payout_schedule" data-toggle="modal" class="btn btn-sm btn-success" style="display: inline !important; float: right !important;"><i class="fa fa-plus"></i> Add New Payout</a>-->
                           </h4>
                           <br />
